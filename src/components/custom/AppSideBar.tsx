            ...
            <SidebarContent>
                <SidebarGroup>
                    <div className="p-2 flex items-center gap-2.5">
                        <Image src={avatar} width={40} height={40} alt="User" className="rounded-full" loading="lazy" />
                        <div className="">
                            ...
                            <SidebarMenuItem className={pathname === "/transaction" ? "c_active" : ""}>
                                <SidebarMenuButton asChild>
                                    <Link href={"/transaction"}>
                                        <Image
                                            src={pathname === "/transaction" ? "/assets/_transaction.svg" : "/assets/transaction.svg"}
                                            width={16}
                                            height={16}
                                            alt="Dashboard"
                                            loading="lazy"
                            ...
                            <Collapsible className="group/collapsible">
                                        ...
                                        <SidebarMenuSub>
                                            <SidebarMenuSubItem className={pathname === "/location" ? "c_active" : ""} >
                                                <SidebarMenuButton asChild>
                                                    <Link href={"/location"} >
                                                        <Image
                                                            src={pathname === "/location" ? "/assets/_location.svg" : "/assets/location.svg"}
                                                            alt="location"
                                                            width={16}
                                                            height={16}
                                                            loading="lazy"
                                            ...
                                            <SidebarMenuSubItem className={pathname === "/jobtype" ? "c_active" : ""} >
                                                <SidebarMenuButton asChild>
                                                    <Link href={"/jobtype"} >
                                                        <Image
                                                            src={pathname === "/jobtype" ? "/assets/_vector.svg" : "/assets/vector.svg"}
                                                            alt="Job type"
                                                            width={14}
                                                            height={14}
                                                            loading="lazy"
                                ...
                                <SidebarMenuItem className={pathname === "/service" ? "c_active" : ""}>
                                    <SidebarMenuButton asChild>
                                        <Link href={"/service"} >
                                            <Image
                                                src={pathname === "/service" ? "/assets/_service.svg" : "/assets/service.svg"}
                                                alt="service"
                                                width={16}
                                                height={16}
                                                loading="lazy"
                            ...
                            <SidebarMenuItem className={pathname === "/documentation" ? "c_active" : ""}>
                                <SidebarMenuButton asChild>
                                    <Link href={"/documentation"} >
                                        <Image
                                            src={pathname === "/documentation" ? "/assets/_documentation.svg" : "/assets/documentation.svg"}
                                            alt="documentation"
                                            width={16}
                                            height={16}
                                            loading="lazy"
