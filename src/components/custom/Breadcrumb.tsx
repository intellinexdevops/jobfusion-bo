        ...
        <section className='px-4'>
            <div className='flex items-center justify-between h-[58px]'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm text-primary font-medium leading-6'>{moment(today).format("MMMM DD, YYYY")}</span>
                </div>
            </div>
            <div className='capitalize text-3xl font-semibold text-neutral-700'>
                {breadcrumbs[0]}
            </div>
        </section>
    )
